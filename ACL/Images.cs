...
namespace ACL
{
    class Images
    {
        ...
        //public string ConvertToTumbnail(string path)
        //{
        ...
        //    string path = Server.MapPath("~/") + hash + ".jpg";

        //    ResizeAndSaveHighQualityImage(SetGrayscale(imgToResize), 140, 105, path, 100);
        //    return path;
        //}
        ...
        enum ColorFilterTypes { Red, Green, Blue }
      ...
      Color.FromArgb(255 - c.R, 255 - c.G, 255 - c.B));
        ...
        {
            Bitmap _bitmapPrevCropArea = (Bitmap)_currentBitmap;
        ...
        enum i_bitmap { Width = 100, Height = 100 }
